...
# import SimpleITK
import numpy
from clinical_data_process import *
...
def interf0_handler():
    ...
    # Process the inputs: any way you'd like
    clinical_data_predict_time = clinical_main(INPUT_PATH / "chimera-clinical-data-of-bladder-cancer-recurrence-patients.json",
                                               MODEL_PATH)
    ...
    write_json_file(
        ...
        content=clinical_data_predict_time,
    )
...
if __name__ == "__main__":
    raise SystemExit(interf0_handler())   # run()
